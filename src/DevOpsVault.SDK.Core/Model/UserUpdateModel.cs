...
namespace DevOpsVault.SDK.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserUpdateModel :  IEquatable<UserUpdateModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserUpdateModel" /> class.
        /// </summary>
        ...
        public UserUpdateModel(string externalId = default(string), string password = default(string), string provider = default(string))
        {
        ...
        {
            return this.Equals(input as UserUpdateModel);
        }

        /// <summary>
        /// Returns true if UserUpdateModel instances are equal
        /// </summary>
        /// <param name="input">Instance of UserUpdateModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserUpdateModel input)
        {
            if (input == null)
                return false;
