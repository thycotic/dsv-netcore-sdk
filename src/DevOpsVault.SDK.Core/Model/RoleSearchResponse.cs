...
namespace DevOpsVault.SDK.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoleSearchResponse :  IEquatable<RoleSearchResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="data">List of matching roles.</param>
        ...
        public RoleSearchResponse(string cursor = default(string), List<RoleResponse> data = default(List<RoleResponse>), long length = default(long), long limit = default(long))
        {
            this.Cursor = cursor;
            this.Data = data;
            this.Length = length;
        ...
        /// </summary>
        /// <value>List of matching roles</value>
        ...
        {
            return this.Equals(input as RoleSearchResponse);
        }

        /// <summary>
        /// Returns true if RoleSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleSearchResponse input)
        {
            if (input == null)
                return false;
