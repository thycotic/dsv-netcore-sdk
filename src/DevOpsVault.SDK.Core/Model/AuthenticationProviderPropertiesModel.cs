...
namespace DevOpsVault.SDK.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthenticationProviderPropertiesModel :  IEquatable<AuthenticationProviderPropertiesModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticationProviderPropertiesModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticationProviderPropertiesModel {\n");
        ...
        {
            return this.Equals(input as AuthenticationProviderPropertiesModel);
        }

        /// <summary>
        /// Returns true if AuthenticationProviderPropertiesModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticationProviderPropertiesModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticationProviderPropertiesModel input)
        {
            if (input == null)
                return false;
