...
namespace DevOpsVault.SDK.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupSearch :  IEquatable<GroupSearch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupSearch" /> class.
        /// </summary>
        /// <param name="cursor">Cursor to next batch of results.</param>
        /// <param name="data">Groups that match the search term.</param>
        ...
        public GroupSearch(string cursor = default(string), List<Group> data = default(List<Group>), long length = default(long), long limit = default(long))
        {
            this.Cursor = cursor;
            this.Data = data;
            this.Length = length;
        ...
        /// </summary>
        /// <value>Groups that match the search term</value>
        ...
        {
            return this.Equals(input as GroupSearch);
        }

        /// <summary>
        /// Returns true if GroupSearch instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupSearch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupSearch input)
        {
            if (input == null)
                return false;
